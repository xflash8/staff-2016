<?php
class Group_Member_Card extends Card{
	...
	?>
		...
		<div class="card">
			...
			<ul class="tab-nav tn-justified" style="overflow: hidden;" tabindex="1">
					...
					<li class="active waves-effect"><a href="?sub=group-member">Member</a></li>
						...
						?>
							<div class="lv-item media item-<?php echo $user->ID;?>">
								...
								<div class="media-body">
									...
									<small class="lv-small status-<?php echo $user->ID;?> <?php echo $show;?>">Admin</small>
		...
		function notify(message, from, align, icon, type, animIn, animOut){
			...
			$(document).ready(function(){
				...
				$('a.remove').click(function(e){
					...
					$.ajax({
						url: '?ajax=member_remove&pagename='+get.pagename,
						type: 'POST',
						data: data,
						success: function(r){
							console.log(r);
				...
				$('a.promote').click(function(e){
					...
					$.ajax({
						url: '?ajax=promote_member&pagename='+get.pagename,
						type: 'POST',
						data: data,
						success: function(r){
							console.log(r);
				...
				$('a.downgrade').click(function(e){
					...
					$.ajax({
						url: '?ajax=member_downgrade&pagename='+get.pagename,
						type: 'POST',
						data: data,
						success: function(r){
							console.log(r);
